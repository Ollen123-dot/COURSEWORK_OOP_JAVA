...
public class StudentRegistration extends Application {
    ...
    private CheckBox CMI,CSE,Electrical,EC,Mechanical;
    private VBox deptBox;
    ...
    public void start(Stage primaryStage) {
        ...
        // Department dropdown
        CMI = new CheckBox("Civil");
        CSE = new CheckBox("CSE");
        Electrical = new CheckBox("Electrical");
        EC = new CheckBox("E&C");
        Mechanical = new CheckBox("Mechanical");

        deptBox = new VBox(5); // spacing of 5px
        deptBox.getChildren().addAll(CMI, CSE, Electrical, EC, Mechanical);
    ...
    private void handleSubmit() {
        ...
        yearBox.getValue() == null || monthBox.getValue() == null ||
        dayBox.getValue() == null || genderGroup.getSelectedToggle() == null ||
        (!CMI.isSelected() && !CSE.isSelected() && !Electrical.isSelected()
         && !EC.isSelected() && !Mechanical.isSelected())) {
        ...
        if (CMI.isSelected()) deptBuilder.append("Civil, ");
        if (CSE.isSelected()) deptBuilder.append("CSE, ");
        if (Electrical.isSelected()) deptBuilder.append("Electrical, ");
        if (EC.isSelected()) deptBuilder.append("E&C, ");
        if (Mechanical.isSelected()) deptBuilder.append("Mechanical, ");

        String dept = deptBuilder.substring(0, deptBuilder.length() - 2);
    ...
    try {
        ...
        String url = "jdbc:ucanaccess://C:/Database/Students.accdb";
