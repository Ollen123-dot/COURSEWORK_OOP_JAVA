...
this.expenses = expenses;
 ...
 public void makedeposit( double newbalance){
    System.out.print("enter the deposit amount; ");
    Scanner deposit = new Scanner(System.in);
    double newdeposit = deposit.nextDouble();
    balance = newbalance - newdeposit;
    deposits = newdeposit;
...
//vehicle.ChangeBalance(highestBid);
 ...
 vehicle.makedeposit(highestBid);
